...
class PetFriends:
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        """Метод отправляет на сервер об обновлении данных питомуа по указанному ID и
    ...
    def set_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет запрос на сервер об добавлении/бновлении фото питомуа по указанному ID и
        возвращает статус запроса и result в формате JSON с данными питомца включая фото"""
